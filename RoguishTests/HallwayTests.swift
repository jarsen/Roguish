...
class HallwayTests : XCTestCase {
    ...
    func testHallwayBetweenNonOverlappingRoomsWithLeftLowerFromBottomWallToLeftWall() {
        ...
        let expectedRect0 = Rect(origin: Point(5, 10), size: Size(width: 1, height: 11))
        let expectedRect1 = Rect(origin: Point(5, 20), size: Size(width: 11, height: 1))
        XCTAssertTrue(expectedRect0.intersects(expectedRect1))
    ...
    func testHallwayBetweenNonOverlappingRoomsWithLeftLowerFromRightWallToTopWall() {
        ...
        let expectedRect0 = Rect(origin: Point(20, 5), size: Size(width: 1, height: 11))
        let expectedRect1 = Rect(origin: Point(10, 5), size: Size(width: 11, height: 1))
        XCTAssertTrue(expectedRect0.intersects(expectedRect1))
        XCTAssertEqual(hallway.rects[0], expectedRect0)
        XCTAssertEqual(hallway.rects[1], expectedRect1)
    }
    ...
    func testHallwayBetweenNonOverlappingRoomsWithRightLowerFromTopWallToLeftWall() {
        ...
        let expectedRect0 = Rect(origin: Point(5, 5), size: Size(width: 1, height: 11))
        let expectedRect1 = Rect(origin: Point(5, 5), size: Size(width: 11, height: 1))
        XCTAssertTrue(expectedRect0.intersects(expectedRect1))
        XCTAssertEqual(hallway.rects[0], expectedRect0)
        XCTAssertEqual(hallway.rects[1], expectedRect1)
    }
    ...
    func testHallwayBetweenNonOverlappingRoomsWithRightLowerFromRightWallToBottomWall() {
        ...
        let expectedRect0 = Rect(origin: Point(20, 10), size: Size(width: 1, height: 11))
        let expectedRect1 = Rect(origin: Point(10, 20), size: Size(width: 11, height: 1))
        XCTAssertTrue(expectedRect0.intersects(expectedRect1))
        XCTAssertEqual(hallway.rects[0], expectedRect0)
        XCTAssertEqual(hallway.rects[1], expectedRect1)
    }
